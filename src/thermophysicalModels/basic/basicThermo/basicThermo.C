...
/*
Foam::volScalarField& Foam::basicThermo::had()
{
    //notImplemented("basicThermo::had()");
    return const_cast<volScalarField&>(volScalarField::null());
	return had();
}

const Foam::volScalarField& Foam::basicThermo::had() const
{
    //notImplemented("basicThermo::had()");
    return const_cast<volScalarField&>(volScalarField::null());
}

Foam::tmp<Foam::scalarField> Foam::basicThermo::had
(
    const label patchi
) const
{
