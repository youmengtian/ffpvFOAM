...
// Chemistry readers based on absoluteEnthalpy
...
makeChemistryReader(constGasHsThermoPhysics);
makeChemistryReader(gasHsThermoPhysics);
makeChemistryReader(constIncompressibleGasHsThermoPhysics);
makeChemistryReader(incompressibleGasHsThermoPhysics);
makeChemistryReader(icoPoly8HsThermoPhysics);

makeChemistryReaderType(foamChemistryReader, constGasHsThermoPhysics);
makeChemistryReaderType(foamChemistryReader, gasHsThermoPhysics);
makeChemistryReaderType
(
    foamChemistryReader,
    constIncompressibleGasHsThermoPhysics
);
makeChemistryReaderType(foamChemistryReader, incompressibleGasHsThermoPhysics);
makeChemistryReaderType(foamChemistryReader, icoPoly8HsThermoPhysics);
