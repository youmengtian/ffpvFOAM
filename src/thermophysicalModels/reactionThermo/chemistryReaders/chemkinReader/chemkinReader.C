...
namespace Foam
{
    addChemistryReaderType(chemkinReader, gasHsThermoPhysics);
}
...
(
    ...
    DynamicList<gasHsReaction::specieCoeffs>& lhs,
    DynamicList<gasHsReaction::specieCoeffs>& rhs,
    ...
    switch (rType)
    {
        case irreversible:
        {
            ...
            (
                ...
                <Reaction, gasHsThermoPhysics, ReactionRateType>
                (
                    Reaction<gasHsThermoPhysics>
                    (
                        speciesTable_,
                        lhs.shrink(),
                        rhs.shrink(),
    ...
    switch (rrType)
    {
            ...
            if (rType == nonEquilibriumReversible)
            {
                ...
                (
                    new NonEquilibriumReversibleReaction
                        <Reaction, gasHsThermoPhysics, ArrheniusReactionRate>
                    (
                        Reaction<gasHsThermoPhysics>
                        (
                            speciesTable_,
        ...
        case LandauTeller:
        {
            ...
            if (rType == nonEquilibriumReversible)
            {
                ...
                (
                    new NonEquilibriumReversibleReaction
                        <Reaction, gasHsThermoPhysics, LandauTellerReactionRate>
                    (
                        Reaction<gasHsThermoPhysics>
                        (
                            speciesTable_,
