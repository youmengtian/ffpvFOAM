...
namespace Foam
{
    ...
    makeReactions(constGasHsThermoPhysics, constGasHsReaction)
    makeReactions(gasHsThermoPhysics, gasHsReaction)
    makeReactions
    (
        constIncompressibleGasHsThermoPhysics,
        constIncompressibleGasHsReaction
    )
    makeReactions(incompressibleGasHsThermoPhysics, incompressibleGasHsReaction)
    makeReactions(icoPoly8HsThermoPhysics, icoPoly8HsReaction)
}
