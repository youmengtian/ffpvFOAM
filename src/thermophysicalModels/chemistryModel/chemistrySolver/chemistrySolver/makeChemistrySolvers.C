...
namespace Foam
{
    ...
    makeChemistrySolverTypes(rhoChemistryModel, constGasHsThermoPhysics);
    makeChemistrySolverTypes(rhoChemistryModel, gasHsThermoPhysics);
    makeChemistrySolverTypes
    (
        rhoChemistryModel,
    ...
    (
        rhoChemistryModel,
        incompressibleGasHsThermoPhysics
    );
    makeChemistrySolverTypes(rhoChemistryModel, icoPoly8HsThermoPhysics);
