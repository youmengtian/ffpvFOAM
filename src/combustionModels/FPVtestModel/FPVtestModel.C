...
FPVtestModel<CombThermoType, ThermoType>::FPVtestModel
(
...
template<class CombThermoType, class ThermoType>
hashedWordList FPVtestModel<CombThermoType, ThermoType>::tables()
{
...
template<class CombThermoType, class ThermoType>
void FPVtestModel<CombThermoType, ThermoType>::correct()
{
       ...
       forAll(Y_, i)
       {
          ...
          forAll(fCells, cellI)
          {
        	 if (i == 0)
        	 {
                ...
                // PVmax = 0.2883;//test by jianhong 
                 PVNormCells[cellI] = max(min(PVCells[cellI],1),0);
                 x[0] = PVNormCells[cellI];
//                 Info << "test PV Source Term normalized" <<endl;
                 //Calculate Zeta
          ...
          forAll(Y_, i)
          {
              ...
              forAll(pY , facei)
              {
             	 if (i == 0)
             	 {
                     // Calculate normalized PV
                 //    PVmax = 0.2883; //test by jianhong
                     pPVNorm[facei] = max(min(pPV[facei],1),0);
                     x[0] = pPVNorm[facei];
...
Info << "codeis here 000, meaning that it is the test model applied" <<endl; //add to test by jianhong 20191024

}

// mehdi 21032018   Foam::tmp<Foam::volScalarField>
template<class CombThermoType, class ThermoType>
void FPVtestModel<CombThermoType, ThermoType>::correctCurrentFields
(
...
FPVtestModel< CombThermoType, ThermoType>::getHRs() const
{
...
template<class CombThermoType, class ThermoType>
Foam::tmp<Foam::volScalarField>
FPVtestModel< CombThermoType, ThermoType>::getT() const
{
...
template<class CombThermoType, class ThermoType>
Foam::tmp<Foam::volScalarField>
FPVtestModel< CombThermoType, ThermoType>::getPVs() const
{
...
template<class CombThermoType, class ThermoType>
Foam::tmp<Foam::volScalarField>
FPVtestModel< CombThermoType, ThermoType>::getYi(const label& i) const
{
...
template<class CombThermoType, class ThermoType>
Switch FPVtestModel<CombThermoType, ThermoType>::correctDensity()
{
	return true;
}
...
FPVtestModel<CombThermoType, ThermoType>::R
(
    volScalarField& Y              
) const
{
...
template<class CombThermoType, class ThermoType>
Foam::tmp<Foam::volScalarField>
FPVtestModel< CombThermoType, ThermoType>::Sh() const
{
...
template<class CombThermoType, class ThermoType>
Foam::tmp<Foam::volScalarField>
FPVtestModel< CombThermoType, ThermoType>::dQ() const
{
...
template<class CombThermoType, class ThermoType>
bool FPVtestModel<CombThermoType, ThermoType>::read()
{
