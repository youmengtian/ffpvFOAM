...
const List<List<scalarList> > linearInterpolation::defaultList(0.0); //Dimension 3DFGMFoam
...
linearInterpolation::linearInterpolation(const fvMesh& mesh, const word& tableName, const IOdictionary& tableDict)
:
