...
flameletTable::flameletTable(const fvMesh& mesh, const word& tableName, const IOdictionary& tableDict)
:
...
Foam::flameletTable::New(const fvMesh& mesh, const word& tableName, const IOdictionary& tableDict)
{
    ...
    return cstrIter()(mesh, tableName, tableDict);
}
